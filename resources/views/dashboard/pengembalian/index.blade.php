...
<div class="w-full flex justify-end">
    <div class="pt-24 px-5 w-full lg:w-3/4 xl:w-4/5 pb-10">
        <a href="/dashboard/pengembalian/create">
            <button class="px-4 py-2 text-sm lg:text-md font-medium bg-blue-500 rounded-md mb-3">Tambah pengembalian</button>
        </a>
        ...
        @endif
        <div class="w-full">
            <h1 class="text-md lg:text-lg xl:text-xl font-semibold mb-2">Pengembalian Terbaru</h1>
